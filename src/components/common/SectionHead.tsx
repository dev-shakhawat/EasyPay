...
export default function SectionHead({title , subtitle , customeStyle , subtitleStyle}:sectionheadprops) {
  return (
    <div  className={customeStyle}>
        ...
        <h2 className={`${subtitleStyle} font-urbanist font-medium md:font-semibold lg:font-bold xl:text-[40px] lg:text-[36px] md:text-[32px] sm:text-[28px] text-[24px] text-[#01081B] leading-[120%] mt-1    `}>{subtitle}</h2>
