...
export default function HowToStep({id , icon , title , subtitle , lineShape}:howtostepprops) {
  return (
    <div
      className={`w-fit relative px-6 pb-6 text-center lg:text-left ${ lineShape
      ? 'after:content-[""] after:absolute after:top-1/2 xl:after:-right-[40px] lg:after:-right-[5px] after:-translate-y-1/2 lg:after:w-[2px]  after:h-[68%] after:bg-gradient-to-b after:from-[#f9f9f9] after:via-[#e0e0e0] after:to-[#f9f9f9]'
      : '' }`} >
